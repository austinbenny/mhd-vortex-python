...
\begin{frame}{Why Orszag-Tang}
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      \includegraphics[width=\linewidth]{ot128_rho.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Density at t = 0.5, $128^{2}$}
  \centering
  \includegraphics[width=0.58\textwidth]{ot128_rho.pdf}
  \vspace{-0.5em}
  \begin{itemize}
...
\begin{frame}{Thermal and magnetic pressure, t = 0.5}
  \begin{columns}[c]
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot128_p.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot128_pmag.pdf}
    \end{column}
  \end{columns}
  \vspace{0.3em}
...
\begin{frame}{Formation of the current sheet}
  \begin{columns}[c]
    \begin{column}{0.33\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot128_t01_rho.pdf}\\ \scriptsize t = 0.1
    \end{column}
    \begin{column}{0.33\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot128_t03_rho.pdf}\\ \scriptsize t = 0.3
    \end{column}
    \begin{column}{0.33\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot128_rho.pdf}\\ \scriptsize t = 0.5
    \end{column}
  \end{columns}
  \vspace{0.3em}
  \begin{itemize}\scriptsize
...
\begin{frame}{Convergence in density}
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot_convergence.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
...
\begin{frame}{Divergence control and conservation}
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ot128_divb_history.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{itemize}
